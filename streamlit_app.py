...
weight = "object_detection_yolov3/yolov3.weights"
cfg = "object_detection_yolov3/darknet/cfg/yolov3.cfg"

net = cv2.dnn.readNet(weight, cfg)

classes = []
with open("object_detection_yolov3/darknet/data/coco.names", "r") as f:
